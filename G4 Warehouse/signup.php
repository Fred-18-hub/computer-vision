            ...
            <div class="col-lg-6 m-auto mb-4 ">
                <div class="card mb-4 gradient container">
                    <div class="card-title">
                        <h3 class="text-white text-center py-2"> Enter Registration Details </h3>
                    </div>
                    <div class="card-body">
                        <form action="insert.php" method="post">
                            <input type="text" class="form-control mb-2 box box" placeholder=" First Name " name="firstname" >
                            <input type="text" class="form-control mb-2 box" placeholder=" Last Name " name="lastname" >
                            <input type="text" class="form-control mb-2 box" placeholder=" User Name " name="username" >
                            <input type="email" class="form-control mb-2 box" placeholder=" Email " name="email" >
                            <input type="password" class="form-control mb-2 box" placeholder=" Password " name="password" >
                            <div class="form-control mb-2 box">
                            <label for="dob-day" class="control-label">Date of birth</label>
                            <div >
                              <select name="dob-day" class="form-label box">
                              ...
                              <select name="dob-month" class="form-label box">
                              ...
                              <select name="dob-year" class="form-label box">
                          ...
                          <input type="text" class="form-control mb-2 box" placeholder=" Region " name="region" >
                          <input type="text" class="form-control mb-2 box" placeholder=" City " name="city" >
                          <input type="text" class="form-control mb-2 box" placeholder=" Address " name="address" >

                          <div class="form-control mb-2 box">
                          <label for="phone" class="control-label box">Telephone number</label>
                          <div >
                          <input type="tel" name="phone" class="box" placeholder=" eg. 0233333333 " pattern="[0-9]{10}">
                         </div>
                         </div>
                         ...
                         <div class="col-md-5  container justify-item-center">
                            <br><button class="btn btn-info btn-warning text-white" name="submit">Register Me</button>
                            </div>
                        </form>
                    </div>
                </div>
